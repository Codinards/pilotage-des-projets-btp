...
use App\Command\Utils\DoctrineHelper;
use App\Command\Utils\FormTypeRenderer;
use App\Command\Utils\Generator as UtilsGenerator;
...
class CrudCommand extends AbstractMaker
{
    ...
    public function __construct(
        ...
        private UtilsGenerator $generator
    ) {
